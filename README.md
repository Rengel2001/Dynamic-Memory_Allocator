...
information from the original README file given with the assignment.
...
Credits for all source code and the assignment information above goes to the CSE 320 TA's from the spring 2023 semester and
Professor Stark. My contributions include implementing all of the features described above, which can be found in the sfmm.c file.
